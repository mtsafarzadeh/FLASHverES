...
#include "Flash.h"
   ...
   integer, dimension(1:30), parameter :: varnames = (/&
   & DEIT_VAR, DFOR_VAR, DONE_VAR, DTWO_VAR, FREI_VAR, &
     FRFR_VAR, FRON_VAR, FRTW_VAR, THEI_VAR, THFR_VAR, &
     THON_VAR, THTW_VAR, TWEI_VAR, TWFR_VAR, TWON_VAR, &
     TWTW_VAR, ACCX_VAR, ACCY_VAR, ACCZ_VAR, DENS_VAR, &
     EINT_VAR, ENER_VAR, GAMC_VAR, GAME_VAR, PRES_VAR, &
     SHOK_VAR, TEMP_VAR, VELX_VAR, VELY_VAR, VELZ_VAR &
   &/)

   integer, dimension(1:30), parameter :: vartypes = (/&
