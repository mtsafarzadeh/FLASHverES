!!****if* source/flashUtilities/interpolation/cubic/ut_biCubicFd1
!!
!! NAME
!!
!!  ut_biCubicFd1
...
!! SYNOPSIS
!!
!!  ut_biCubicFd1 (real, intent (in) :: a (1:16),
!!                 real, intent (in) :: x,
!!                 real, intent (in) :: y)
!!
!! DESCRIPTION
!!
!!  Calculates the function and rescaled 1st derivative value for a pair [x,y] of
!!  rescaled [0,1] coordinates and the 16 bicubic expansion coefficients. The bicubic
...
!!
!!           ut_biCubicFd1 (1) = the function value
!!           ut_biCubicFd1 (2) = the rescaled d/dx value
!!           ut_biCubicFd1 (3) = the rescaled d/dy value
!!
!!  2) The code checks, if the supplied pair [x,y] is rescaled.
!!
!!***

function ut_biCubicFd1 (a,x,y)
  ...
  real    :: ut_biCubicFd1 (1:3)     ! declares the function as an array
...
!
  ...
  if (notRescaled) then
      call Logfile_stamp     (x, ' = rescaled x coordinate [ut_biCubicFd1]'    )
      call Logfile_stamp     (y, ' = rescaled y coordinate [ut_biCubicFd1]'    )
      call Driver_abortFlash ('[ut_biCubicFd1] ERROR: [x,y] pair not rescaled!')
  end if
!
!
...
!
!
  ut_biCubicFd1 (1) = sum (xy (1:16) * a (1:16))
!
!
...
!
  ...
  ut_biCubicFd1 (2) = p + q + q + r + r + r    ! this is d/dx

  p = sum ( xy (1: 4) * a ( 5: 8) )
  q = sum ( xy (5: 8) * a ( 9:12) )
  r = sum ( xy (9:12) * a (13:16) )

  ut_biCubicFd1 (3) = p + q + q + r + r + r    ! this is d/dy
!
!
!     ...Ready!
!
