...
! sweep over all the zones
      do k = lowZ,highZ
         do j = lowY,highY
            do i = lowX,highX
               tmp = solnData(TEMP_VAR,i,j,k)*csm_scaleFactor**2
...
!   3 factors because the density is lower by a factor of a^3
!   2 factors because eint is scaled down by a^2 so you need to get it in those
!   units
                  sdot = sdot/csm_scaleFactor**5 
