...
module Simulation_data
  ...
  real, save :: sim_beta, sim_bangle  ! plasma beta and angle with flow direction
  real, save :: sim_bx, sim_by, sim_magp ! bfield mag in both directions and magnetic pressure
