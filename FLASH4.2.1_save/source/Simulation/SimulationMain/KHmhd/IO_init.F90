...
subroutine IO_init()
  ...
  use IO_data
  use Simulation_data,  ONLY : sim_tcc
...
! compute the interval between checkpoint files in units of cloud crushing time
  io_checkpointFileIntervalTime = io_checkpointFileIntervalTime * sim_tcc
