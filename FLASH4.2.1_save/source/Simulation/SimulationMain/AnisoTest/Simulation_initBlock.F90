...
#include "Flash.h"
  ...
  real, allocatable, dimension(:) :: xCoord,yCoord,zCoord, xCoordL,yCoordL,YCoordR, xCoordR
  ...
  do k = blkLimitsGC(LOW,KAXIS),blkLimitsGC(HIGH,KAXIS)
     ...
     do j = blkLimitsGC(LOW,JAXIS),blkLimitsGC(HIGH,JAXIS)
        ...
        do i = blkLimitsGC(LOW,IAXIS),blkLimitsGC(HIGH,IAXIS)
           ...
           if (((xx .lt. sim_xmax*3./4).and.(xx .gt. sim_xmax/4.)).and. &
               ((yy .lt. sim_xmax*3./4).and.(yy .gt. sim_xmax/4.))) then
