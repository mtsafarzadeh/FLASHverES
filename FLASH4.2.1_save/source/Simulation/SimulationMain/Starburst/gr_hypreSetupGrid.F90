...
#include "Flash_mpi.h"  
  ...
  !!-----------------------------------------------------------------------
  !!     ES 11.i5 Institute Periodic Boundary Conditions 
  !!-----------------------------------------------------------------------      
  !print *,'About to call SetPeriodic After case this just dies here' 
  periodic(1)=dr_axisNumProcs(1)*NXB
  periodic(2)=dr_axisNumProcs(2)*NYB
  periodic(3)=dr_axisNumProcs(3)*NZB
  !call HYPRE_SStructGridSetPeriodic(gr_hypreGrid,part,periodic)
  !print *,'Just called SetPeriodic ' 
