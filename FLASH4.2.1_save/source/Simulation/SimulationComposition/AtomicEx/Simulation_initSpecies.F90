!!****if* source/Simulation/SimulationComposition/Simulation_initSpecies
!!
!! NAME
!!
...
#include "Multispecies.h"
  ...
  integer, parameter :: SPEC_UNIT=2,SPEC_NUM=52
  ...
  do while((count<NSPECIES).and.(i<=SPEC_NUM))
     i=i+1
     read(SPEC_UNIT,*)isotopeName,abar,zbar,neutrons,electrons,bindEnergy,gamma
	...
	!    print *, i,abar,zbar,neutrons,electrons,bindEnergy,gamma
	!write(*,'(A,I,6(A,1pe10.3))'), 'i: ', i, ' A: ', abar, ' Z:', zbar, ' Neut: ', neutrons, ' Elec: ', electrons, ' BE: ', bindEnergy, ' Gamma: ', gamma
     end if
  end do
  close(SPEC_UNIT)
#endif
