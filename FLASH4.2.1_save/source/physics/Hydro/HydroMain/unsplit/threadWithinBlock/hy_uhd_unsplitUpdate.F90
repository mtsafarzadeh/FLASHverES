...
#include "UHD.h"
  ...
  logical :: hy_E_upwind, hy_mref, hy_hallVelocity, &
             hy_useMagneticResistivity, hy_conserveAngField
#endif
    ...
    !$omp hy_smalldens,hy_forceHydroLimit,hy_order,hy_E_upwind,hy_conserveAngField,&
    !$omp blockID,del,dataSize,blkLimits,hy_unsplitEosMode,hy_mref,&
    !$omp hy_geometry,hdt,faceAreas,cellVolumes,range_switch,hy_useauxeinteqn) &
    !$omp private(spn,FL,FR,GL,GR,HL,HR,IntEner,tempPres,i,j,k,U0,Jp,Jm,&
    ...
    !$omp alpha,dx_sph,leftFac,rghtFac,dPdr,rvol,cs,eta,sumspecies,isph,&
