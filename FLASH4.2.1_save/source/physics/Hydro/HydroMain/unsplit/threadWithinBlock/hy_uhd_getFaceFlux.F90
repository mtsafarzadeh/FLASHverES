...
#include "Flash_omp.h"
...
#ifdef FIXEDBLOCKSIZE
  real, dimension(GRID_IHI_GC) :: xCenter, xLeft, xRight, yCenter
#else
  real, dimension(datasize(IAXIS)) :: xCenter, xLeft, xRight, yCenter
#endif
  ...
  !$omp blockID,vecLen,eosMask,xflux,yflux,zflux,&
  ...
  !$omp kUSM,k3,k2,hy_spcl,hy_spcr,hy_hydrocomputedtoption, &
