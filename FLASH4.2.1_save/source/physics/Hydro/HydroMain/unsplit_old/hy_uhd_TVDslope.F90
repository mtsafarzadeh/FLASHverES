!!****if* source/physics/Hydro/HydroMain/unsplit_old/hy_uhd_TVDslope
!!
!! NAME
!!
!!  hy_uhd_TVDslope
...
Subroutine hy_uhd_TVDslope(dir,VLL,VL,V0,VR,VRR,lambdaL,lambda,lambdaR,leig,delbar)
  ...
  use Hydro_data,           ONLY : hy_limiter
...
!!$#endif
  ...
  if (hy_limiter==MINMOD) then
     if (hy_charLimiting) then
        do k=1,HY_WAVENUM
           delbar(k)=minmod(dot_product(leig(k,:),delV_L(HY_DENS:HY_VARINUM)),&
                            dot_product(leig(k,:),delV_R(HY_DENS:HY_VARINUM)))
        enddo
  ...
  elseif (hy_limiter==MC) then
     if (hy_charLimiting) then
        do k=1,HY_WAVENUM
           delbar(k)=mc(dot_product(leig(k,:),delV_L(HY_DENS:HY_VARINUM)),&
                        dot_product(leig(k,:),delV_R(HY_DENS:HY_VARINUM)))
        enddo
  ...
  elseif (hy_limiter==VANLEER) then
     if (hy_charLimiting) then
        do k=1,HY_WAVENUM
           delbar(k)=vanLeer(dot_product(leig(k,:),delV_L(HY_DENS:HY_VARINUM)),&
                             dot_product(leig(k,:),delV_R(HY_DENS:HY_VARINUM)))
        enddo
  ...
  elseif (hy_limiter==HYBRID) then
     if (hy_charLimiting) then
        ...
        delbar(HY_FASTLEFT)=&
             minmod(dot_product(leig(HY_FASTLEFT,:),delV_L(HY_DENS:HY_VARINUM)),&
                    dot_product(leig(HY_FASTLEFT,:),delV_R(HY_DENS:HY_VARINUM)))
#ifdef FLASH_USM_MHD
        delbar(HY_ALFNLEFT)=&
                 mc(dot_product(leig(HY_ALFNLEFT,:),delV_L(HY_DENS:HY_VARINUM)),&
                    dot_product(leig(HY_ALFNLEFT,:),delV_R(HY_DENS:HY_VARINUM)))
#endif
        delbar(HY_SLOWLEFT)=&
             minmod(dot_product(leig(HY_SLOWLEFT,:),delV_L(HY_DENS:HY_VARINUM)),&
                    dot_product(leig(HY_SLOWLEFT,:),delV_R(HY_DENS:HY_VARINUM)))

        delbar(HY_ENTROPY)=&
                 mc(dot_product(leig(HY_ENTROPY,:), delV_L(HY_DENS:HY_VARINUM)),&
                    dot_product(leig(HY_ENTROPY,:), delV_R(HY_DENS:HY_VARINUM)))

        delbar(HY_SLOWRGHT)=&
             minmod(dot_product(leig(HY_SLOWRGHT,:),delV_L(HY_DENS:HY_VARINUM)),&
                    dot_product(leig(HY_SLOWRGHT,:),delV_R(HY_DENS:HY_VARINUM)))
#ifdef FLASH_USM_MHD
        delbar(HY_ALFNRGHT)=&
                 mc(dot_product(leig(HY_ALFNRGHT,:),delV_L(HY_DENS:HY_VARINUM)),&
                    dot_product(leig(HY_ALFNRGHT,:),delV_R(HY_DENS:HY_VARINUM)))
#endif
        delbar(HY_FASTRGHT)=&
             minmod(dot_product(leig(HY_FASTRGHT,:),delV_L(HY_DENS:HY_VARINUM)),&
                    dot_product(leig(HY_FASTRGHT,:),delV_R(HY_DENS:HY_VARINUM)))
  ...
  elseif (hy_limiter==LIMITED) then
     if (hy_charLimiting) then
        do k=1,HY_WAVENUM
           del1=dot_product(leig(k,:),delV_L(HY_DENS:HY_VARINUM))
           del2=dot_product(leig(k,:),delV_R(HY_DENS:HY_VARINUM))
           if (del2 > 0.) then
