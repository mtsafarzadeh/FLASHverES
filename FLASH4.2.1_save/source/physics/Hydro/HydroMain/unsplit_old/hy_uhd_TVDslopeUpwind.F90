!!****if* source/physics/Hydro/HydroMain/unsplit_old/hy_uhd_TVDslopeUpwind
!!
!! NAME
!!
...
!!                        real(IN)    :: leig(HY_WAVENUM,HY_VARINUM),
!!                        real(OUT)   :: delbar(MDIM,1:HY_VARINUMMAX))
!!
!! DESCRIPTION
!!
     ...
     if (hy_charLimiting) then !mc char limiting
        do k=1,HY_WAVENUM
           ...
           if (lambda(HY_ENTROPY) > epsilon) then
              ...
              delbar(k)=mc(dot_product(leig(k,:), V0(HY_DENS:HY_VARINUM)- VL(HY_DENS:HY_VARINUM)),&
                           dot_product(leig(k,:), VL(HY_DENS:HY_VARINUM)-VLL(HY_DENS:HY_VARINUM)))
              ...
              case(HY_ENTROPY)
                 ...
                 delbar(k)=mc(delbar(k),dot_product(leig(k,:), del(HY_DENS:HY_VARINUM) ))
              end select

           ! (2) normal velocity < 0.
           elseif (lambda(HY_ENTROPY) < -epsilon) then
              delbar(k)=mc(dot_product(leig(k,:), VRR(HY_DENS:HY_VARINUM)-VR(HY_DENS:HY_VARINUM)),&
                           dot_product(leig(k,:),  VR(HY_DENS:HY_VARINUM)-V0(HY_DENS:HY_VARINUM)))
           ...
           ! (3) normal velocity = 0.
              ...
              delbar(k)=mc(dot_product(leig(k,:), delR1(HY_DENS:HY_VARINUM)),&
                           dot_product(leig(k,:), delL1(HY_DENS:HY_VARINUM)))
           endif
     ...
     if (hy_charLimiting) then !minmod char limiting
        do k=1,HY_WAVENUM
           ...
           if (lambda(HY_ENTROPY) > epsilon) then
              ...
              delbar(k)=minmod(dot_product(leig(k,:), V0(HY_DENS:HY_VARINUM)- VL(HY_DENS:HY_VARINUM)),&
                               dot_product(leig(k,:), VL(HY_DENS:HY_VARINUM)-VLL(HY_DENS:HY_VARINUM)))
...
#endif                 
                 del(HY_DENS:HY_VARINUM) = delR1(HY_DENS:HY_VARINUM)
                 delbar(k)=minmod(delbar(k),dot_product(leig(k,:), del(HY_DENS:HY_VARINUM) ))
              end select

           ! (2) normal velocity < 0.
           elseif (lambda(HY_ENTROPY) < -epsilon) then
              delbar(k)=minmod(dot_product(leig(k,:), VRR(HY_DENS:HY_VARINUM)-VR(HY_DENS:HY_VARINUM)),&
                               dot_product(leig(k,:),  VR(HY_DENS:HY_VARINUM)-V0(HY_DENS:HY_VARINUM)))
           ...
           ! (3) normal velocity = 0.
              ...
              delbar(k)=minmod(dot_product(leig(k,:), delR1(HY_DENS:HY_VARINUM)),&
                               dot_product(leig(k,:), delL1(HY_DENS:HY_VARINUM)))
           endif
     ...
     if (hy_charLimiting) then !vanLeer char limiting
        do k=1,HY_WAVENUM
           ...
           if (lambda(HY_ENTROPY) > epsilon) then
              ...
              delbar(k)=vanLeer(dot_product(leig(k,:), V0(HY_DENS:HY_VARINUM)- VL(HY_DENS:HY_VARINUM)),&
                                dot_product(leig(k,:), VL(HY_DENS:HY_VARINUM)-VLL(HY_DENS:HY_VARINUM)))
...
#endif                 
                 del(HY_DENS:HY_VARINUM) = delR1(HY_DENS:HY_VARINUM)
                 delbar(k)=vanLeer(delbar(k),dot_product(leig(k,:), del(HY_DENS:HY_VARINUM) ))
              end select

           ! (2) normal velocity < 0.
           elseif (lambda(HY_ENTROPY) < -epsilon) then
              delbar(k)=vanLeer(dot_product(leig(k,:), VRR(HY_DENS:HY_VARINUM)-VR(HY_DENS:HY_VARINUM)),&
                                dot_product(leig(k,:),  VR(HY_DENS:HY_VARINUM)-V0(HY_DENS:HY_VARINUM)))
           ...
           ! (3) normal velocity = 0.
              ...
              delbar(k)=vanLeer(dot_product(leig(k,:), delR1(HY_DENS:HY_VARINUM)),&
                                dot_product(leig(k,:), delL1(HY_DENS:HY_VARINUM)))
           endif
  ...
  elseif (hy_limiter==HYBRID) then
     ...
     if (hy_charLimiting) then
        ...
        if (lambda(HY_ENTROPY) > epsilon) then
           ...
           delbar(HY_FASTLEFT)=&
                minmod(dot_product(leig(HY_FASTLEFT,:),V0(HY_DENS:HY_VARINUM)- VL(HY_DENS:HY_VARINUM)),&
                       dot_product(leig(HY_FASTLEFT,:),VL(HY_DENS:HY_VARINUM)-VLL(HY_DENS:HY_VARINUM)))

#ifdef FLASH_USM_MHD
           delbar(HY_ALFNLEFT)=&
                mc(dot_product(leig(HY_ALFNLEFT,:),V0(HY_DENS:HY_VARINUM)-VL(HY_DENS:HY_VARINUM)),&
                   dot_product(leig(HY_ALFNLEFT,:),VR(HY_DENS:HY_VARINUM)-V0(HY_DENS:HY_VARINUM)))

#endif
           delbar(HY_SLOWLEFT)=&
                minmod(dot_product(leig(HY_SLOWLEFT,:),V0(HY_DENS:HY_VARINUM)- VL(HY_DENS:HY_VARINUM)),&
                       dot_product(leig(HY_SLOWLEFT,:),VL(HY_DENS:HY_VARINUM)-VLL(HY_DENS:HY_VARINUM)))

           delbar(HY_ENTROPY)=&
                mc(dot_product(leig(HY_ENTROPY,:), V0(HY_DENS:HY_VARINUM)-VL(HY_DENS:HY_VARINUM)),&
                   dot_product(leig(HY_ENTROPY,:), VR(HY_DENS:HY_VARINUM)-V0(HY_DENS:HY_VARINUM)))

           delbar(HY_SLOWRGHT)=&
                minmod(dot_product(leig(HY_SLOWRGHT,:),V0(HY_DENS:HY_VARINUM)- VL(HY_DENS:HY_VARINUM)),&
                       dot_product(leig(HY_SLOWRGHT,:),VL(HY_DENS:HY_VARINUM)-VLL(HY_DENS:HY_VARINUM)))

#ifdef FLASH_USM_MHD
           delbar(HY_ALFNRGHT)=&
                mc(dot_product(leig(HY_ALFNRGHT,:),V0(HY_DENS:HY_VARINUM)-VL(HY_DENS:HY_VARINUM)),&
                   dot_product(leig(HY_ALFNRGHT,:),VR(HY_DENS:HY_VARINUM)-V0(HY_DENS:HY_VARINUM)))
#endif
           delbar(HY_FASTRGHT)=&
                minmod(dot_product(leig(HY_FASTRGHT,:),V0(HY_DENS:HY_VARINUM)- VL(HY_DENS:HY_VARINUM)),&
                       dot_product(leig(HY_FASTRGHT,:),VL(HY_DENS:HY_VARINUM)-VLL(HY_DENS:HY_VARINUM)))


           ! (2) normal velocity < 0.
        elseif (lambda(HY_ENTROPY) < -epsilon) then
           delbar(HY_FASTLEFT)=&
                minmod(dot_product(leig(HY_FASTLEFT,:),VRR(HY_DENS:HY_VARINUM)-VR(HY_DENS:HY_VARINUM)),&
                       dot_product(leig(HY_FASTLEFT,:),VR(HY_DENS:HY_VARINUM)- V0(HY_DENS:HY_VARINUM)))
#ifdef FLASH_USM_MHD
           delbar(HY_ALFNLEFT)=&
                mc(dot_product(leig(HY_ALFNLEFT,:),V0(HY_DENS:HY_VARINUM)-VL(HY_DENS:HY_VARINUM)),&
                   dot_product(leig(HY_ALFNLEFT,:),VR(HY_DENS:HY_VARINUM)-V0(HY_DENS:HY_VARINUM)))
#endif
           delbar(HY_SLOWLEFT)=&
                minmod(dot_product(leig(HY_SLOWLEFT,:),VRR(HY_DENS:HY_VARINUM)-VR(HY_DENS:HY_VARINUM)),&
                       dot_product(leig(HY_SLOWLEFT,:),VR(HY_DENS:HY_VARINUM)- V0(HY_DENS:HY_VARINUM)))
           ...
           delbar(HY_SLOWRGHT)=&
                minmod(dot_product(leig(HY_SLOWRGHT,:),VRR(HY_DENS:HY_VARINUM)-VR(HY_DENS:HY_VARINUM)),&
                       dot_product(leig(HY_SLOWRGHT,:),VR(HY_DENS:HY_VARINUM)- V0(HY_DENS:HY_VARINUM)))
#ifdef FLASH_USM_MHD
           delbar(HY_ALFNRGHT)=&
                mc(dot_product(leig(HY_ALFNRGHT,:),V0(HY_DENS:HY_VARINUM)-VL(HY_DENS:HY_VARINUM)),&
                   dot_product(leig(HY_ALFNRGHT,:),VR(HY_DENS:HY_VARINUM)-V0(HY_DENS:HY_VARINUM)))
#endif
           delbar(HY_FASTRGHT)=&
               minmod(dot_product(leig(HY_FASTRGHT,:),VRR(HY_DENS:HY_VARINUM)-VR(HY_DENS:HY_VARINUM)),&
                      dot_product(leig(HY_FASTRGHT,:),VR(HY_DENS:HY_VARINUM) -V0(HY_DENS:HY_VARINUM)))
