...
HYPRE_PATH = /work/01734/evan1022/hypre-2.9.0b/src/install
FFLAGS_TEST  = ${FFLAGS_OPT} -fp-model precise
FFLAGS_HYPRE = -I${HYPRE_PATH}/include
LIB_HYPRE = -L${HYPRE_PATH}/lib -lHYPRE

F90FLAGS = -I ${TACC_HDF5_INC} -DH5_USE_16_API
...
CFLAGS_HDF5  = -I${TACC_HDF5_INC} -DH5_USE_16_API -I /work/01734/evan1022/hypre-2.9.0b/src/install/include
...
LIB_HDF4 =
LIB_HDF5 = -L${TACC_HDF5_LIB} -lhdf5_fortran -lhdf5 -lz
LIB_PNG  = -lpng
