...
#include "Flash.h"
   ...
   integer, dimension(1:14), parameter :: varnames = (/&
   & ACCX_VAR, ACCY_VAR, ACCZ_VAR, DENS_VAR, EINT_VAR, &
     ENER_VAR, GAMC_VAR, GAME_VAR, PRES_VAR, SHOK_VAR, &
     TEMP_VAR, VELX_VAR, VELY_VAR, VELZ_VAR &
   &/)

   integer, dimension(1:14), parameter :: vartypes = (/&
   & VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_PER_VOLUME, VARTYPE_PER_MASS,&
     VARTYPE_PER_MASS, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC,&
     VARTYPE_GENERIC, VARTYPE_PER_MASS, VARTYPE_PER_MASS, VARTYPE_PER_MASS &
   &/)
