...
#include "constants.h"
    ...
    integer, PARAMETER :: NUM_UNITS = 29
...
"Grid/GridMain/UG"
    i = i + 1; unit_names(i) = &
"Grid/GridSolvers/HYPRE/UG"
    i = i + 1; unit_names(i) = &
"Grid/GridSolvers/Pfft/DirectSolver"
    i = i + 1; unit_names(i) = &
